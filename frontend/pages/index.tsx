    ...
    >
      ...
      <header className="border-b border-gray-800 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            <Link href="/">
              <h1 className="text-xl font-bold">CrossFusion</h1>
        ...
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-2xl mx-auto">
              The seamless Swap between Ethereum and NEAR Protocol. 
              Swap tokens across chains with confidence and security.
            </p>
          </div>
      ...
      <footer className="border-t border-gray-800 py-6 mt-20">
        <div className="max-w-7xl mx-auto px-6 text-center text-gray-400">
          <p>&copy; 2025 CrossFusion. Built for Unite DeFi Hackathon.</p>
        </div>
      </footer>
    </div>
  );
