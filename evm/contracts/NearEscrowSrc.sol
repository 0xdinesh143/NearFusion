...
contract NearEscrowSrc is Escrow {
    ...
    /// @notice Near address where funds should be sent
    ...
    /**
     * @notice Records Near address for the swap
     * @dev Links Near address to escrow for verification
     * @param hashlock The escrow hashlock
     * @param NearAddress The Near address where funds should be sent
     * @param immutables The escrow immutables
     */
    function recordNearAddress(
        ...
        onlyValidImmutables(immutables)
    {
        // Only maker can record Near address
